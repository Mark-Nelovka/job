...
export default function DetailedJob({
  ...
  }, [ctx.items, location.query.id, data, errorCode]);

  return (
    <>
      {error && <Error statusCode={errorCode} />}
      <section>
                ...
                <div key={job.id}>
                  ...
                  <div className="detailed__info">
                    <p>
                      ...
                      key role on a multidisciplinary team of cardiologists and
                      surgeons.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      procedures per year. The cardiac service line is the only
                      center in Georgia with the Joint Commission’s
                      Comprehensive Cardiac Center certification.
                    </p>
                  </div>
                  <h2 className="detailed__titles">Compensation & Benefits:</h2>
                  <ul>
